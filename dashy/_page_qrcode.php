<?php
// Query untuk menampilkan data di tabel utama
$result_qr = $koneksi->query("
    SELECT d.id_peserta, d.name, d.qr_token, d.is_used 
    FROM data d 
    ORDER BY d.name ASC
");

// --- SEMUA QUERY DARI form_data_qr.php DIPINDAHKAN KE SINI UNTUK MENGISI MODAL ---

// 1. Query untuk dropdown 'ID Peserta'
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Mengambil elemen dropdown dari dalam modal
    const idPesertaSelect = document.getElementById('id_peserta');
    const namaWargaSelect = document.getElementById('name');

    // JavaScript untuk menyamakan pilihan dropdown (sama seperti original)
